(function() {
  window.app.controller('HomeLandingController', [
    '$scope', '$state', '$stateParams', 'AlertService', 'TestimonialService', 'TextService', 'ValidationService', function($scope, $state, $stateParams, AlertService, TestimonialService, TextService, ValidationService) {
      $scope.isAdmin = false;
      ...
      return $scope.goToBooking = function(postalCode) {
