(function() {
  window.app.controller('HomeApplicationController', [
    '$scope', '$stateParams', 'CategoryService', 'GoogleMapsService', 'TextService', 'AlertService', 'CompanyCustomer', 'Mission', 'PrivateCustomer', function($scope, $stateParams, CategoryService, GoogleMapsService, TextService, AlertService, CompanyCustomer, Mission, PrivateCustomer) {
      $scope.category = [];
      ...
      TextService.getTexts('HomeApplicationController', 'sv').success(function(data, status, headers, config) {
